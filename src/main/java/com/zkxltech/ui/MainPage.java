			...
			closeLabel.addMouseListener(new MouseAdapter() {
				...
				public void mouseDown(MouseEvent e) {
					...
					case Constant.BUSINESS_ANSWER:
						message = "Please stop answering the questions";//请先停止答题
						break;
					case Constant.BUSINESS_SCORE:
						message = "Please stop grading";//请先停止评分
						break;
					case Constant.BUSINESS_VOTE:
						message = "Please stop voting";//请先停止投票
						break;
					case Constant.BUSINESS_ATTENDEN:
						message = "Please stop checking";//请先停止签到
						break;
					case Constant.BUSINESS_PREEMPTIVE:
						message = "Please stop answering";//请先停止抢答
						break;
					case Constant.BUSINESS_CLASSTEST:
						message = "Please collect the examination papers";//请先收取试卷
						break;
					case Constant.BUSINESS_BIND:
						message = "Please stop binding";//请先停止绑定
						break;
					default:
						return;
					}
